...
if("TRUE" STREQUAL "TRUE")
  set(tuw_voronoi_graph_SOURCE_PREFIX /home/nazha/sim_ws/src/tuw_multi_robot/tuw_voronoi_graph)
  set(tuw_voronoi_graph_DEVEL_PREFIX /home/nazha/sim_ws/devel)
  ...
  set(tuw_voronoi_graph_INSTALL_PREFIX /home/nazha/sim_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tuw_voronoi_graph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nazha/sim_ws/src/tuw_multi_robot/tuw_voronoi_graph/${idir}'.  ${_report}")
    endif()
